...
files = {
    "IDU": IDU.read_text(encoding="utf-8"),
    "EXU": EXU.read_text(encoding="utf-8"),
    "IFU": IFU.read_text(encoding="utf-8"),
}
...
IDU.write_text(files["IDU"], encoding="utf-8")
EXU.write_text(files["EXU"], encoding="utf-8")
IFU.write_text(files["IFU"], encoding="utf-8")
